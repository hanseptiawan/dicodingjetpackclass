...
public class TvShowContentFragment extends Fragment {

    private ContentAdapter contentAdapter;
    private List<ContentEntity> contentEntityList;

    public TvShowContentFragment() {
    }

    public TvShowContentFragment newInstance() {
        return new TvShowContentFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            contentEntityList = contentViewModel.getTvShows();
